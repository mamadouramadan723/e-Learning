...
class _LoginPageWidgetState extends State<LoginPageWidget> {
  ...
  void initState() {
    ...
    _model.passwordConfirmationSignUpController ??= TextEditingController();
  }
                                ...
                                children: [
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (currentUserEmailVerified) {
                                          ...
                                          ScaffoldMessenger.of(context)
                                            ...
                                            SnackBar(
                                              content: Text(
                                                'You have to verify your mail first',
                                                style: TextStyle(
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 24.0, 0.0, 0.0),
                                    child: Text(
                                      'Or Use Social Network to Login',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium,
                                    ),
                                  ),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      controller: _model
                                          .passwordConfirmationSignUpController,
                                      autofocus: true,
                                      obscureText: !_model
                                          .passwordConfirmationSignUpVisibility,
                                      decoration: InputDecoration(
                                        labelText: 'Password',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium,
                                        ...
                                        suffixIcon: InkWell(
                                          ...
                                          focusNode:
                                              FocusNode(skipTraversal: true),
                                          child: Icon(
                                            _model.passwordConfirmationSignUpVisibility
                                                ? Icons.visibility_outlined
                                                : Icons.visibility_off_outlined,
                                            size: 24.0,
                                          ),
